...
def group_by_centroid(restaurants, centroids):
    ...
    location_closest_central=[find_closest(j,centroids) for j in location_list]
    pair=[[location_closest_central[k],restaurants[k]] for k in range(len(location_list)) ]
